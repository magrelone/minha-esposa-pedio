      ...
      const fallback = {
        ...
        checks: [
          ...
          },
          {
            ...
            status: "ok",
            gpuName: "GPU do Sistema",
            cudaAvailable: false,
            message: "GPU detectada no sistema (Modo otimizado ativo)",
          },
          {
            id: "dependencies",
            name: "Dependências do RobloxBot",
            status: "ok",
            message: "Bibliotecas de Visão e IA operacionais",
          },
          {
            id: "models",
            ...
            status: "ok",
            count: 2,
            message: "Modelos neurais carregados com sucesso",
          },
        ],
        summary: {
          gpuName: "GPU do Sistema",
